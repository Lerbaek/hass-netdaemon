...
//   At: 2024-03-06T20:33:24.4442013+01:00
//
...
public partial class AutomationEntities
{
    ...
    ///<summary>Controller - EnOcean PTM 215Z (Friends of Hue) switch</summary>
    public AutomationEntity ControllerEnoceanPtm215zFriendsOfHueSwitch => new(_haContext, "automation.controller_enocean_ptm_215z_friends_of_hue_switch");
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Bevægelse i stuen Motion</summary>
    ...
    ///<summary>Bevægelse på Ebbes værelse Motion</summary>
...
public partial class NumberEntities
{
    ...
    ///<summary>Badeværelse Balance</summary>
    public NumberEntity BadevaerelseBalance => new(_haContext, "number.badevaerelse_balance");
...
public partial class ScriptEntities
{
    ...
    public ScriptEntity IndkorselRegnbue => new(_haContext, "script.indkorsel_regnbue");
...
public partial class SensorEntities
{
    ...
    ///<summary>Grasputin Rainsensor Delay</summary>
...
public partial class LandroidCloudServices
{
    ...
    ///<summary>Restarts or reboots device</summary>
    ///<param name="target">The target for this service call</param>
    ...
    ///<summary>Set wheel torque (if supported)</summary>
    ///<param name="target">The target for this service call</param>
...
public partial record LandroidCloudSetzoneParameters
{
...
public partial record LandroidCloudTorqueParameters
{
...
public partial class ScriptServices
{
    ...
    public void IndkorselRegnbue()
    {
        _haContext.CallService("script", "indkorsel_regnbue", null);
    }
...
public static class LandroidCloudEntityExtensionMethods
{
    ...
    ///<param name="multizoneDistances">Set multizone distance array in meters. 0 = Disabled. Format: 15, 80, 120, 155 eg: 15, 80, 120, 155</param>
    ///<param name="multizoneProbabilities">Set multizone probabilities array. Format: 50, 10, 20, 20 eg: 50, 10, 20, 20</param>
    public static void Config(this LawnMowerEntity target, long? raindelay = null, long? timeextension = null, string? multizoneDistances = null, string? multizoneProbabilities = null)
    {
    ...
    ///<param name="multizoneDistances">Set multizone distance array in meters. 0 = Disabled. Format: 15, 80, 120, 155 eg: 15, 80, 120, 155</param>
    ///<param name="multizoneProbabilities">Set multizone probabilities array. Format: 50, 10, 20, 20 eg: 50, 10, 20, 20</param>
    public static void Config(this IEnumerable<LawnMowerEntity> target, long? raindelay = null, long? timeextension = null, string? multizoneDistances = null, string? multizoneProbabilities = null)
    {
        target.CallService("config", new LandroidCloudConfigParameters { Raindelay = raindelay, Timeextension = timeextension, MultizoneDistances = multizoneDistances, MultizoneProbabilities = multizoneProbabilities });
    }

    ///<summary>Start edgecut (if supported)</summary>
    public static void Edgecut(this LawnMowerEntity target)
    {
        target.CallService("edgecut");
    }

    ///<summary>Start edgecut (if supported)</summary>
    public static void Edgecut(this IEnumerable<LawnMowerEntity> target)
    {
        target.CallService("edgecut");
    }
    ...
    ///<summary>Restarts or reboots device</summary>
    public static void Restart(this LawnMowerEntity target)
    {
        target.CallService("restart");
    }

    ///<summary>Restarts or reboots device</summary>
    public static void Restart(this IEnumerable<LawnMowerEntity> target)
    {
        target.CallService("restart");
    }
    ...
    ///<summary>Set which zone to be mowed next</summary>
    public static void Setzone(this LawnMowerEntity target, LandroidCloudSetzoneParameters data)
    {
        target.CallService("setzone", data);
    }

    ///<summary>Set which zone to be mowed next</summary>
    public static void Setzone(this IEnumerable<LawnMowerEntity> target, LandroidCloudSetzoneParameters data)
    {
        target.CallService("setzone", data);
    }
    ...
    ///<param name="target">The LawnMowerEntity to call this service for</param>
    ///<param name="zone">Sets the zone number, ranging from 0 to 3, to be mowed next eg: 1</param>
    public static void Setzone(this LawnMowerEntity target, object zone)
    {
    ...
    ///<param name="target">The IEnumerable&lt;LawnMowerEntity&gt; to call this service for</param>
    ///<param name="zone">Sets the zone number, ranging from 0 to 3, to be mowed next eg: 1</param>
    public static void Setzone(this IEnumerable<LawnMowerEntity> target, object zone)
    {
        target.CallService("setzone", new LandroidCloudSetzoneParameters { Zone = zone });
    }

    ///<summary>Set wheel torque (if supported)</summary>
    public static void Torque(this LawnMowerEntity target, LandroidCloudTorqueParameters data)
    {
        target.CallService("torque", data);
    }

    ///<summary>Set wheel torque (if supported)</summary>
    public static void Torque(this IEnumerable<LawnMowerEntity> target, LandroidCloudTorqueParameters data)
    {
        target.CallService("torque", data);
    }
    ...
    ///<param name="target">The LawnMowerEntity to call this service for</param>
    ///<param name="torque">Set wheel torque. Ranging from -50% to 50% eg: 22</param>
    public static void Torque(this LawnMowerEntity target, long torque)
    {
    ...
    ///<param name="target">The IEnumerable&lt;LawnMowerEntity&gt; to call this service for</param>
    ///<param name="torque">Set wheel torque. Ranging from -50% to 50% eg: 22</param>
    public static void Torque(this IEnumerable<LawnMowerEntity> target, long torque)
    {
        target.CallService("torque", new LandroidCloudTorqueParameters { Torque = torque });
    }
}
