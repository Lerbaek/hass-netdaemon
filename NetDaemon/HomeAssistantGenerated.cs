...
//   At: 2024-04-24T20:35:21.9977060+02:00
//
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Indkorsel Motion</summary>
...
public partial class NumberEntities
{
    ...
    ///<summary>Grasputin Torque</summary>
    public NumberEntity GrasputinTorque => new(_haContext, "number.grasputin_torque");
    ///<summary>Indkorsel Motion sensitivity</summary>
...
public partial class SelectEntities
{
    ...
    ///<summary>Indkorsel Day night mode</summary>
...
public partial class UpdateEntities
{
    ...
    ///<summary>Indkorsel Firmware</summary>
...
{
    ///<summary>Move the camera with a specific speed.</summary>
    public static void PtzMove(this ButtonEntity target, ReolinkPtzMoveParameters data)
    {
        target.CallService("ptz_move", data);
    }

    ///<summary>Move the camera with a specific speed.</summary>
    public static void PtzMove(this IEnumerable<ButtonEntity> target, ReolinkPtzMoveParameters data)
    {
        target.CallService("ptz_move", data);
    }

    ///<summary>Move the camera with a specific speed.</summary>
    ///<param name="target">The ButtonEntity to call this service for</param>
    ///<param name="speed">PTZ move speed.</param>
    public static void PtzMove(this ButtonEntity target, long speed)
    {
        target.CallService("ptz_move", new ReolinkPtzMoveParameters { Speed = speed });
    }

    ///<summary>Move the camera with a specific speed.</summary>
    ///<param name="target">The IEnumerable&lt;ButtonEntity&gt; to call this service for</param>
    ///<param name="speed">PTZ move speed.</param>
    public static void PtzMove(this IEnumerable<ButtonEntity> target, long speed)
    {
        target.CallService("ptz_move", new ReolinkPtzMoveParameters { Speed = speed });
    }
}
